...
const DEFAULT_CHOICES: Record<Category, string[]> = {
  ...
  scale:       ["Major", "Dorian", "Phrygian", "Lydian", "Mixolydian", "Minor Scale", "Locrian", "Harmonic Minor", "Melodic Minor", "Blues", "Pentatonic Major", "Dorian ♭2", "Lydian Augmented", "Lydian Dominant", "Mixolydian ♭6", "Locrian ♯2", "Altered", "Whole Tone", "Half-Whole Diminished", "Whole-Half Diminished"],
};
