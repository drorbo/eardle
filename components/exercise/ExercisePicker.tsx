...
import { CATEGORY_TOPICS, Difficulty, Exercise } from "@/types/exercise";
...
export function dedupeItems(exercises: Exercise[]): PickerItem[] {
...
// The reusable "pick a set of exercises, grouped by difficulty" checkbox grid —
// shared by the public Custom Package picker and the admin lesson editor's
// practice-package field, so the selection logic only exists in one place.
export function ExercisePicker({ exercises, selected, onChange }: Props) {
